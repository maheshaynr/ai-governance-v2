...
Ensure the regex uses word boundaries if appropriate and correctly catches the data. The regex should be based on PII Presidio library format. Do NOT include any markdown formatting or explanation."""
