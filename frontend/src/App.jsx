...
// Every endpoint but /system_status now requires an X-API-Key header (see auth.py), so
// the whole app sits behind one login gate here rather than each tab handling it -- the
// Chat Bot, Testing Dashboard and Analytics tabs have no login UI of their own.
